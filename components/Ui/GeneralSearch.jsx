...
const SearchDashboard = ({text}) => {
  ...
  return (
    <div className="min-h-screen bg-gray-100 px-4 py-6">
      ...
      <h1 className="text-3xl font-semibold text-start text-emerald-900 mb-6">General Search</h1>
      ...
      <div className="bg-white shadow-md rounded-md p-6 w-full  mx-auto flex flex-wrap gap-4 justify-between">
        ...
        <div className="flex items-end w-[180px]">
          <button onClick={fetchData} className="w-full bg-emerald-900  text-white py-2 px-4 rounded-full">
            Search
          </button>
        </div>
      </div>

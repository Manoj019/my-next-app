...
const TrackPo = () => {
  ...
  return (
    <><h1 className="text-3xl font-semibold text-start text-[#0C344B] mb-6">Track PO</h1>
      <div className="bg-white shadow-md rounded-md p-6 w-300  mx-auto flex flex-wrap gap-4 justify-between mt-6">
